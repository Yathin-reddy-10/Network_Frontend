...
import { UserPermissionsProvider } from "./feature-module/UserPermissionsContext";
import ErrorBoundary from "./feature-module/academic/examinations/ErrorBoundary";
...
root.render(
  <React.StrictMode>
    <Provider store={store}>
      <ErrorBoundary> {/* Wrap the UserPermissionsProvider with ErrorBoundary */}
