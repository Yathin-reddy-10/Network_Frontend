...
const PaymentDues = () => {
  ...
  const fetchExams = async (_page: number, searchQuery: string) => {
    ...
    try {
      const response = await fetch(
        `${webApi}/provider/branch_connection_payment/?page=${_page}&search=${searchQuery}`,
        options
      );
  ...
  const viewPaymentDuesHistory = (branchConnectionId: any) => {
    // Clear previous data
    ...
    const apiUrl = `${webApi}/provider/branch_connection_payment_dues_log_detail/${branchConnectionId}/`;
    ...
    fetch(apiUrl, options)
        ...
        if (data.results && data.results.length > 0) {
          const modalContent = data.results
            .map((record: { [key: string]: any }) => {
              let recordContent = `<table className="table table-striped">`;

              // if (record.branch_name) {
              //   recordContent += `
              //     <tr>
              //       <td><strong style="color: #007bff; width: 150px;">Branch Name:</strong></td>
              ...
              if (record.billing_frequency_in_months) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Billing Frequency:</strong></td>
                    <td>${record.billing_frequency_in_months}</td>
                  </tr>`;
              }
              if (record.total_price) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Total Price:</strong></td>
              ...
              if (record.recharge_from) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Recharge From:</strong></td>
                    <td>${record.recharge_from}</td>
                  </tr>`;
              }
              if (record.recharge_to) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Recharge To:</strong></td>
                    <td>${record.recharge_to}</td>
                  </tr>`;
              }
              if (record.last_payment_duration) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Last Payment Duration:</strong></td>
                    <td>${record.last_payment_duration}</td>
                  </tr>`;
              }
              if (record.next_payment_due_date) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Next Payment Due Date:</strong></td>
                    <td>${record.next_payment_due_date}</td>
                  </tr>`;
              }
              if (record.approval_status_name) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Approval Status:</strong></td>
                    <td>${record.approval_status_name}</td>
                  </tr>`;
              }
              if (record.invoice_submitted_date) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Invoice Submitted Date:</strong></td>
                    <td>${record.invoice_submitted_date}</td>
                  </tr>`;
              }
              if (record.payment_status_name) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Payment Status:</strong></td>
                    <td>${record.payment_status_name}</td>
                  </tr>`;
              }
              if (record.IT_remarks) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">IT Remarks:</strong></td>
                    <td>${record.IT_remarks}</td>
                  </tr>`;
              }
              if (record.invoice_number) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Invoice Number:</strong></td>
              ...
              if (record.invoice_date) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Invoice Date:</strong></td>
              ...
              if (record.changed_by_name) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Changed By:</strong></td>
              ...
              if (record.change_date) {
                recordContent += `
                  <tr>
                    <td><strong style="color: #007bff; width: 150px;">Change Date:</strong></td>
                    <td>${record.change_date}</td>
                  </tr>`;
              }

              recordContent += `</table><hr>`;
      ...
      .catch((error) => {
        console.error("Error fetching payment dues history:", error);
      });
  };
