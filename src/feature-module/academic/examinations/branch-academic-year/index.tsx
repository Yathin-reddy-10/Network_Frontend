...
const BranchAcademicYear = () => {
    ...
    useEffect(() => {
        const fetchData = async (_page: number) => {
            ...
            const examsResponse = await fetch(`http://10.10.8.14/branch/branches_academic_year/`, options);
                ...
                <div className="content">
                    ...
                    <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
                        <div className="my-auto mb-2">
                            <h3 className="page-title mb-1">Academic Year</h3>
                            <nav>
                    ...
                    <div className="card">
                        <div className="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                            <h4 className="mb-3">Academic Year List</h4>
...
export default BranchAcademicYear;
