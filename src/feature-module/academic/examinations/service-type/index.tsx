...
const ServiceTypeDetailsTable = () => {
    ...
    const [newEnginner, setNewEnginner] = useState<Engineer>({
        service_id: null, name: null, is_active:true, has_sub_category:false,
    })
    ...
    const fetchProviderData = async (page: number) => {
        ...
        const response = await fetch(`${webApi}/tickets/service-types/?page=${page}`, options);
    ...
    const updateData = async () => {
        ...
        const url = editingIndex !== null ? `${webApi}/tickets/service-types/${newEnginner.service_id}/` : `${webApi}/tickets/service-types/`;
                ...
                <div className="content" style={{ backgroundImage: 'linear-gradient(160deg, #0093E9 0%, #80D0C7 100%)', minHeight: '99%', margin: '5px', marginTop: '15px', position: 'relative', maxWidth: '99%', overflowY: 'auto', overflowX: 'auto' }}>
                    ...
                    <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
                        <div className="my-auto mb-2">
                            <h3 className="page-title mb-1">Service Type Details</h3>
                            <nav>
        ...
        `}
                    ...
                    <div className="modal-dialog custom-modal-size">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h4 className="modal-title">Add Service Type Details</h4>
                                <button
                                    type="button"
                ...
                <div className="modal fade" id="edit_Provider" tabIndex={-1} aria-hidden="true">
                    <div className="modal-dialog custom-modal-size">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h4 className="modal-title">Edit Service Type Details</h4>
                                <button
                                    type="button"
                                    className="btn-close custom-btn-close"
                                    data-bs-dismiss="modal"
...
export default ServiceTypeDetailsTable